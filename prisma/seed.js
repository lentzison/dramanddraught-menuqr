  ...
  const dayThemes = [
    ...
    },
    {
      ...
      specials: [
        ...
        { name: 'Margarita', price: '$9', category: 'cocktail', displayOrder: 28, section: 'Tequila Classics', description: 'Lunazul Blanco, Lime, Orange Curaçao, Agave', detailText: 'Tequila Citrus Shaken' },
        { name: 'Paloma', price: '$9', category: 'cocktail', displayOrder: 29, section: 'Tequila Classics', description: 'Lunazul Blanco, Lime, Grapefruit, Agave, Soda', detailText: 'Tequila Refreshing Built' },
        { name: "Tommy's Margarita", price: '$9', category: 'cocktail', displayOrder: 30, section: 'Tequila Classics', description: 'Lunazul Blanco, Lime, Agave', detailText: 'Tequila Bright Shaken' },
        { name: 'Oaxaca Old Fashioned', price: '$9', category: 'cocktail', displayOrder: 31, section: 'Tequila Classics', description: 'Reposado Tequila, Mezcal, Agave, Bitters', detailText: 'Agave Spirit-Forward Stirred' },
        { name: 'Siesta', price: '$9', category: 'cocktail', displayOrder: 32, section: 'Tequila Classics', description: 'Lunazul Blanco, Campari, Grapefruit, Lime, Sugar', detailText: 'Tequila Bitter Shaken' },
        { name: 'Mexican Firing Squad', price: '$9', category: 'cocktail', displayOrder: 33, section: 'Tequila Classics', description: 'Lunazul Blanco, Lime, Grenadine, Bitters', detailText: 'Tequila Fruity Shaken' },
        { name: 'Matador', price: '$9', category: 'cocktail', displayOrder: 34, section: 'Tequila Classics', description: 'Lunazul Blanco, Pineapple, Lime', detailText: 'Tequila Tropical Shaken' },
        { name: 'Rosita', price: '$9', category: 'cocktail', displayOrder: 35, section: 'Tequila Classics', description: 'Reposado Tequila, Sweet Vermouth, Dry Vermouth, Campari, Bitters', detailText: 'Agave Bitter Stirred' },

        { name: 'Sidecar', price: '$9', category: 'cocktail', displayOrder: 36, section: 'Brandy Classics', description: 'Brandy, orange curaçao, Lemon', detailText: 'Brandy Citrus Shaken' },
        { name: "Jack Rose", price: '$9', category: 'cocktail', displayOrder: 37, section: 'Brandy Classics', description: "Laird's Apple Brandy, Lemon, Grenadine", detailText: 'Apple Brandy Fruity Shaken' },
        { name: 'Brandy Crusta', price: '$9', category: 'cocktail', displayOrder: 38, section: 'Brandy Classics', description: 'E&J Brandy, Orange Curaçao, Lemon, Maraschino, Bitters', detailText: 'Brandy Complex Shaken' },

        { name: 'Cosmopolitan', price: '$9', category: 'cocktail', displayOrder: 39, section: 'Vodka Classics', description: 'Vodka, Orange Curaçao, Lime, Cranberry', detailText: 'Vodka Fruity Shaken' },
        { name: 'Moscow Mule', price: '$9', category: 'cocktail', displayOrder: 40, section: 'Vodka Classics', description: 'Vodka, Lime, Ginger Beer', detailText: 'Vodka Spicy Built' },
        { name: 'Lemon Drop', price: '$9', category: 'cocktail', displayOrder: 41, section: 'Vodka Classics', description: 'Vodka, Lemon, Triple Sec, Sugar', detailText: 'Vodka Citrus Shaken' },

        { name: 'Aperol Spritz', price: '$9', category: 'cocktail', displayOrder: 42, section: 'Other Classics', description: 'Aperol, Prosecco, Soda Water', detailText: 'Aperitif Sparkling Built' },
        { name: 'Amaretto Sour', price: '$9', category: 'cocktail', displayOrder: 43, section: 'Other Classics', description: 'Amaretto, Bourbon, Lemon, Sugar, Egg White', detailText: 'Liqueur Nutty Shaken' },
        { name: 'Caipirinha', price: '$9', category: 'cocktail', displayOrder: 44, section: 'Other Classics', description: 'Cachaça, Lime, Sugar', detailText: 'Cachaça Citrus Muddled' },
        { name: "Pimm's Cup", price: '$9', category: 'cocktail', displayOrder: 45, section: 'Other Classics', description: "Pimm's No.1, Lemon, Cucumber, Mint, Ginger Ale", detailText: 'Liqueur Refreshing Built' },
      ]
    },
    {
      dayOfWeek: 'WEDNESDAY',
